...
SELECT c.customer_name, c.city, c.grade, s.salesman_name, s.city FROM customers c  
...
SELECT c.customer_name, c.city, s.salesman_name, s.commission FROM customers c  
INNER JOIN salesman s ON c.salesman_id=s.salesman_id  
